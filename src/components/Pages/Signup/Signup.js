    ...
    render() {
        let pageContent = (
            <>
                <Row>
                    <Col>
                        <h3 className="text-center" style={{ color: '	#3689EF' }}>
                            Sign up
                        </h3>
                    </Col>
                </Row>
                <Form className="mt-3" onSubmit={this.sendpost}>
                    <Container>
                            ...
                            <Col xs={{ size: 10, offset: 1 }} sm={{ size: 11, offset: 1 }} md={{ size: 11, offset: 1 }} lg={{ size: 4, offset: 4 }}>
                                <FormGroup>
                                    ...
                                    {!this.state['password'].valid && this.state['password'].touched ? (
                                        <FormText>The password must atleast have 8 characters</FormText>
                                    ) : null}
                                </FormGroup>
                            </Col>
                        </Row>
                        <Row>
                            <Col xs={{ size: 10, offset: 1 }} sm={{ size: 11, offset: 1 }} md={{ size: 11, offset: 1 }} lg={{ size: 4, offset: 4 }}>
                                <FormGroup check row>
                                    <Button id="signup" color="primary" size="md" disabled={!this.isFormValid()}>
                                        Sign up
                                    </Button>
                                </FormGroup>
                            </Col>
                        ...
                        <Row className="mt-1">
                            <Col xs={{ size: 10, offset: 1 }} sm={{ size: 11, offset: 1 }} md={{ size: 11, offset: 1 }} lg={{ size: 4, offset: 4 }}>
                                ...
                                <FormGroup check row>
                                    <Button id="signin" outline color="success" size="md" onClick={this.redirectTo}>
                                        Sign in
                                    </Button>
                                </FormGroup>
                            </Col>
                            ...
                            <Row className="mt-1">
                                <Col xs={{ size: 10, offset: 1 }} sm={{ size: 11, offset: 1 }} md={{ size: 11, offset: 1 }} lg={{ size: 4, offset: 4 }}>
                                    <UncontrolledAlert color="warning" fade={true}>
                                        {this.signUpError(this.props.error)}
                                    </UncontrolledAlert>
                                </Col>
                            </Row>
                        ) : null}
