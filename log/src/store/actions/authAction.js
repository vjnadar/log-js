...
export const auth=(credentials,isSignUp)=>{
    ...
    return dispatch=>{
        ...
        let url='https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyDeXZj90dOi_LxedJuTI-I04iBZkIt80O4';

        if(!isSignUp){

            url='https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyDeXZj90dOi_LxedJuTI-I04iBZkIt80O4';
