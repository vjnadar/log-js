...
class Login extends Component{
    ...
    render(){
        ...
        let pageContent=(
            ...
            <h3 className="text-center" style={{color:'	#2BA75C'}} >Sign in</h3>
                ...
                <Row>
                    ...
                    <Col xs={{size:10,offset:1}} sm={{size:11,offset:1}} md={{size:11,offset:1}} lg={{size:4,offset:4}}>    
                        ...
                        <FormGroup>
                            ...
                            {!this.state['password'].valid&&this.state['password'].touched?<FormText>Please enter a valid password with atleast 8 characters.</FormText>:null}
                ...
                <Row className="mt-1">
                    ...
                    <FormText color="muted" className="mb-1">
                        ...
                        <FormGroup check row> 
                            ...
                            <Button id="signup" outline color="primary" size="md" onClick={this.redirectTo}>Sign up</Button>
                ...
                {this.props.error?
                    ...
                    <Row className="mt-1">
                        ...
                        <Col xs={{size:10,offset:1}} sm={{size:11,offset:1}} md={{size:11,offset:1}} lg={{size:4,offset:4}}>
                            ...
                            <UncontrolledAlert color="warning" fade={true}>{this.loginError(this.props.error)}</UncontrolledAlert>
